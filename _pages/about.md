...
My research interests focus on machine learning, computer vision, knowledge representation, and AI for science. My current research can be broadly categorized into the following directions:
(1). Machine Learning Optimization Algorithms;
(2). Deep Learning for imbalance and few-shot datasets; 
(3). Multi-modality Learning for healthcare;
(4). Large Language Models Powered AI Agents;
(5). Knowledge-enhanced Trusted AI.
