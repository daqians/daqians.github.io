...
- **Daqian Shi**, Xiaoyue Li, Fausto Giunchiglia. KAE: A Property-based Method for Knowledge Graph Alignment and Extension. Journal of Web Semantics, 2024. <!-- (accepted, WoS/SJR Q2 journal) -->
- Ting Wang, **Daqian Shi**, Shengjie Zhao. A Task-Oriented Spatial Graph Structure Learning Method for Traffic Forecasting, IEEE Transactions on Intelligent Transportation Systems, 2024. <!-- (WoS/SJR Q1 journal, IF = 8.5) -->
